...
export default function Customers() {
 ...
 <div className="icon-ring h-10 w-10 rounded-md bg-primary/10 text-primary">
 ...
 <div className="summary-card p-4 flex items-center gap-3">
 <div className="icon-ring h-10 w-10 rounded-md bg-success/10 text-success">
 ...
 <div className="summary-card p-4 flex items-center gap-3">
 <div className="icon-ring h-10 w-10 rounded-md bg-warning/10 text-warning">
 ...
 <div className="summary-card p-4 flex items-center gap-3">
 <div className="icon-ring h-10 w-10 rounded-md bg-destructive/10 text-destructive">
