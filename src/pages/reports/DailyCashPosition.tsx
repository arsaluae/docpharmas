  ...
  return (
    <AppLayout title="Daily Cash Position" subtitle="Live bank balances + 30-day cash flow">
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mb-5">
        ...
        <Card className="glass-card"><CardContent className="p-4 flex items-center gap-3"><div className="h-9 w-9 rounded-xl bg-emerald-500/10 flex items-center justify-center"><ArrowDownCircle className="h-4 w-4 text-emerald-600" /></div><div><p className="text-[10px] text-muted-foreground uppercase tracking-widest font-semibold">Today In</p><p className="text-lg font-bold font-mono">PKR {Math.round(todayIn).toLocaleString()}</p></div></CardContent></Card>
        ...
        <Card className="glass-card"><CardContent className="p-4 flex items-center gap-3"><div className="h-9 w-9 rounded-xl bg-amber-500/10 flex items-center justify-center"><TrendingUp className="h-4 w-4 text-amber-600" /></div><div><p className="text-[10px] text-muted-foreground uppercase tracking-widest font-semibold">Net Today</p><p className={`text-lg font-bold font-mono ${todayIn - todayOut >= 0 ? "text-emerald-600" : "text-destructive"}`}>PKR {Math.round(todayIn - todayOut).toLocaleString()}</p></div></CardContent></Card>
      </div>
