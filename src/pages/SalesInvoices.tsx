...
import { Plus, Search, FileText, Trash2, QrCode, Download, Pencil, ArrowRight } from "lucide-react";
...
export default function SalesInvoices() {
  ...
  const statusColor = (s: string) => {
    if (s === "paid") return "bg-primary/20 text-primary font-semibold";
  ...
  const STATUS_OPTIONS = ["all", "draft", "dispatched", "paid", "overdue"];
          ...
          <div className="p-6">
            ...
            <div className="mb-4 flex flex-wrap items-center gap-3">
              <div className="relative max-w-sm flex-1">
                ...
                <Input placeholder="Search invoices or customer..." className="pl-9" value={search} onChange={e => setSearch(e.target.value)} />
              </div>
