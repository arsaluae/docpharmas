...
export default function PurchaseProforma() {
 ...
 { label: "Invoice", ...invoiceStats, secondLine: `PKR ${invoiceStats.value.toLocaleString()}`, icon: Send, gradient: "from-blue-500/8", iconBg: "from-blue-500", accent: "from-blue-400", textColor: "text-primary", statusKey: "ordered" },
 ].map(s => (
