      ...
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle className="flex items-center gap-2 font-heading">
            <RotateCcw className="h-4 w-4 text-orange-600" /> Return Items {invoiceNumber ? `— ${invoiceNumber}` : ""}
          </DialogTitle>
        </DialogHeader>
        ...
        {!invoiceId ? (
          ...
          <>
            ...
            <div className="flex gap-2 mt-4">
              ...
              <Button onClick={handleSubmit} disabled={!canSubmit || saving} className="flex-1 bg-orange-600 hover:bg-orange-700 text-white">
