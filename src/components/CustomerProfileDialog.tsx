    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
        ...
        <div className="grid grid-cols-2 gap-3">
          <div className="p-3 rounded-lg border border-border bg-gradient-to-br from-emerald-500/10 to-emerald-600/5">
          ...
          <div className="p-3 rounded-lg border border-border bg-gradient-to-br from-orange-500/10 to-orange-600/5">
